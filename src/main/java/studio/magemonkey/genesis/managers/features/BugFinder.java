...
public class BugFinder {
    ...
    public BugFinder(final Genesis plugin) {
        this.plugin = plugin;
    ...
    public void saveConfig() {
        try {
            ...
            Bukkit.getLogger().severe("[" + Genesis.NAME + "] Could not save BugFinder config to " + file);
        }
    }
    ...
    public void warn(String message) {
        addMessage(message);
        Bukkit.getLogger().warning("[" + Genesis.NAME + "] " + message);
    }

    public void severe(String message) {
        addMessage(message);
        Bukkit.getLogger().severe("[" + Genesis.NAME + "] " + message);
    }
